 ...
 * 
 */
@WebServiceClient(name = "MyCalculatorService", targetNamespace = "http://calculator.jaxws.com/", wsdlLocation = "http://127.0.0.1:8084/calc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYCALCULATORSERVICE_QNAME = new QName("http://calculator.jaxws.com/", "MyCalculatorService");
    ...
    public MyCalculator getMyCalculatorPort() {
        return super.getPort(new QName("http://calculator.jaxws.com/", "MyCalculatorPort"), MyCalculator.class);
    }
    ...
    public MyCalculator getMyCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator.jaxws.com/", "MyCalculatorPort"), MyCalculator.class, features);
    }
